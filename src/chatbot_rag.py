...
if st.session_state.vectorstore:
    message_bienvenue = f"{salutation} ! Un document est chargé. Posez vos questions sur son contenu ou sur les indicateurs actuariels."
else:
    message_bienvenue = f"{salutation} ! Je suis votre assistant actuariel. Chargez un document PDF dans la sidebar ou posez une question sur les indicateurs actuariels."
...
# Prompt système
prompt_systeme = """-Ton role : Tu es principalement destiné à des actuaires ou des étudiants en étude d'actuariat. Tu les aideras dans leurs tâches et leur donneras des informations sur des concepts actuariels.
...
- Contexte documentaire : Si un contexte documentaire est fourni, tu bases ta réponse sur ce contexte en priorité et tu indiques que l'information provient du document chargé. Si la réponse n'est pas dans le contexte, tu le dis clairement."""
